 ...
 * forced the scene, the scene wrapper and the HUD to be forked per style. The
 * three styles all track "which item is in front", so they share one atom and
 * the fork disappears.
 */
export const viewerIndexAtom = atom(0)

export type ViewerStyle = 'book' | 'magazine' | 'polaroid'
