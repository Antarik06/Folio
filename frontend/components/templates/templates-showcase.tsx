        ...
        <div className="relative z-10 max-w-[1400px] mx-auto w-full px-8 flex-1 grid lg:grid-cols-2 gap-16 items-center py-12">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              <span className="font-sans text-[10px] font-bold uppercase tracking-[0.4em] text-primary">Popular Album Atelier</span>
          ...
          <div className="flex animate-marquee-slower gap-20 items-center">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="flex gap-20 items-center">
                {["Museum-Grade Typography","◆","Heirloom Quality Design","◆","Editor's Choice Layouts","◆","Trusted by 10k+ Creators","◆"].map((t,idx)=>(
