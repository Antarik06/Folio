...
## Corpus Check
- 246 files · ~315,481 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 773 nodes · 961 edges · 28 communities detected
- Extraction: 70% EXTRACTED · 30% INFERRED · 0% AMBIGUOUS · INFERRED: 287 edges (avg confidence: 0.8)
...
- `ensureAdminProfile()` --calls--> `query()`  [INFERRED]
  backend\src\index.ts → backend\src\db\index.ts

## Communities

### Community 0 - "Community 0"
Cohesion: 0.08
Nodes (57): update(), clientFetch(), serverFetch(), getProfile(), getUser(), signIn(), signInWithGoogle(), signOut() (+49 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (26): Alert(), cleanExternalUrl(), fetchAndDetectFormat(), fileToBase64(), handleParseIdml(), handleReviewAction(), handleUploadPdf(), handleUploadThumb() (+18 more)
...
Cohesion: 0.13
Nodes (15): createAdminClient(), spreadsToFlipbookPages(), autoSelect(), handleCreateAlbumFromCuration(), handleEventClick(), handleEventSelect(), handleFileUpload(), isUuid() (+7 more)
...
Cohesion: 0.67
Nodes (2): GoogleIcon(), handleGoogleSignIn()
...
- **Thin community `Community 33`** (5 nodes): `Carousel()`, `CarouselNext()`, `cn()`, `useCarousel()`, `carousel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (4 nodes): `page.tsx`, `page.tsx`, `GoogleIcon()`, `handleGoogleSignIn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (3 nodes): `page.tsx`, `page.tsx`, `PolaroidPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (3 nodes): `page.tsx`, `retake()`, `startCamera()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (3 nodes): `layers-panel.tsx`, `getDefaultName()`, `inferImageLayerName()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `serverFetch()` connect `Community 0` to `Community 10`, `Community 3`, `Community 5`, `Community 6`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `getUser()` connect `Community 0` to `Community 9`, `Community 3`, `Community 5`, `Community 6`?**
